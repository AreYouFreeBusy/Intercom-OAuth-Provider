...
{
    /// <summary>
    /// Context passed when a Challenge causes a redirect to authorize endpoint in the Intercom OAuth 2.0 middleware
    /// </summary>
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Auth",
        Justification = "OAuth2 is a valid word.")]
    public class IntercomApplyRedirectContext : BaseContext<IntercomAuthenticationOptions>
    {
        /// <summary>
        /// Creates a new context object.
        /// </summary>
        /// <param name="context">The OWIN request context</param>
        /// <param name="options">The Intercom middleware options</param>
        ...
        public IntercomApplyRedirectContext(IOwinContext context, IntercomAuthenticationOptions options,
